    ...
    <header className="sticky top-0 z-50 bg-white shadow-md">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link href="/quote" className="hidden md:block px-6 py-2 bg-accent hover:bg-accent-dark active:bg-orange-700 text-white font-semibold rounded-md transition shadow-sm">
            Get a Quote
          </Link>
          <button 
