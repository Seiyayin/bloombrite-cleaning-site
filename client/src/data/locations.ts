export const locations = [
  ...
  },
  {
    ...
    description: `
      ...
      <p class="mt-4">South Lyon residents choose Bloombrite Cleaning Services for our thorough approach, reliable scheduling, and consistently excellent results. We take pride in helping South Lyon families and business owners maintain clean, healthy environments while freeing up their valuable time for other priorities.</p>
      
      <p class="mt-4">Our cleaning services in South Lyon include <a href="/services/standard-cleaning" class="text-orange-600 hover:text-orange-700">standard cleaning services</a>, <a href="/services/deep-cleaning" class="text-orange-600 hover:text-orange-700">deep cleaning services</a>, <a href="/services/move-in-out-cleaning" class="text-orange-600 hover:text-orange-700">move-in/out cleaning services</a>, recurring maintenance cleaning services, office cleaning services, and specialized cleaning services. Whatever your cleaning services needs, we're committed to providing top-quality cleaning services and complete customer satisfaction. <a href="/quote" class="text-orange-600 hover:text-orange-700">Get a free quote</a> for our professional cleaning services today.</p>
    `,
  ...
  },
  {
    ...
    description: `
      ...
      <p class="mt-4">Walled Lake clients appreciate our attention to detail, reliable cleaning services, and commitment to customer satisfaction. We offer flexible scheduling options to accommodate busy lifestyles and ensure your home or business receives the thorough cleaning services it deserves.</p>
      
      <p class="mt-4">Whether you need regular maintenance cleaning services or a one-time <a href="/services/deep-cleaning" class="text-orange-600 hover:text-orange-700">deep cleaning service</a>, our Walled Lake cleaning services professionals are here to deliver exceptional results. We offer comprehensive cleaning services including <a href="/services/standard-cleaning" class="text-orange-600 hover:text-orange-700">standard cleaning services</a>, <a href="/services/deep-cleaning" class="text-orange-600 hover:text-orange-700">deep cleaning services</a>, and <a href="/services/move-in-out-cleaning" class="text-orange-600 hover:text-orange-700">move-in/out cleaning services</a>. We take pride in helping our clients maintain clean, healthy living and working environments while giving them more time to enjoy beautiful Walled Lake and all the community has to offer. <a href="/quote" class="text-orange-600 hover:text-orange-700">Get a free quote</a> for our cleaning services today.</p>
    `,
  ...
  },
  {
    ...
    description: `
      ...
      <p class="mt-4">Northville residents choose Bloombrite Cleaning Services for our reliable approach, consistent quality, and commitment to customer satisfaction. We take pride in helping maintain the beautiful appearance of Northville properties while respecting the historic character of the community.</p>
