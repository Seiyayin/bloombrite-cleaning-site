                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                  ...
                  <div className="mt-8 pt-6 border-t border-neutral-200">
                    ...
                    <div className="flex space-x-4">
                      <a href="https://www.facebook.com/bloombritecleaning" className="bg-neutral-100 hover:bg-orange-500 hover:text-white active:bg-orange-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors" aria-label="Facebook">
                        <i className="fab fa-facebook-f"></i>
                      </a>
                      <a href="https://www.instagram.com/bloombritecleaning" className="bg-neutral-100 hover:bg-orange-500 hover:text-white active:bg-orange-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors" aria-label="Instagram">
                        <i className="fab fa-instagram"></i>
                      </a>
                      <a href="https://twitter.com/bloombriteclean" className="bg-neutral-100 hover:bg-orange-500 hover:text-white active:bg-orange-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors" aria-label="Twitter">
                        <i className="fab fa-twitter"></i>
                      </a>
                      <a href="https://www.linkedin.com/company/bloombrite-cleaning" className="bg-neutral-100 hover:bg-orange-500 hover:text-white active:bg-orange-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors" aria-label="LinkedIn">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <Button 
                        type="submit" 
                        className="px-8 py-3 bg-primary hover:bg-orange-600 active:bg-orange-700 text-white font-semibold rounded-md transition"
                      >
                        Send Message
                      </Button>
                    </form>
