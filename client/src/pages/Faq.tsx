  ...
  return (
    <>
      <SeoHead 
        ...
        description="Find answers to common questions about BloomBrite Cleaning's professional residential and commercial cleaning services in Michigan."
      />
      <FAQSchema faqs={faqs} />
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a href="tel:1234567890" className="px-8 py-4 bg-white text-primary border border-primary font-bold rounded-md hover:bg-neutral-50 transition shadow-md">
                Call (123) 456-7890
              </a>
            </div>
          </div>
