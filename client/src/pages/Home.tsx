  ...
  return (
    <>
      <SeoHead 
        ...
        description="Trusted house cleaning & maid service in Metro Detroit since 2019. Deep cleaning, recurring service, move-in/out. Book online or text (947) 465-4217."
        canonicalPath="/"
        ogImage={teamImage}
      />
      <LocalBusinessSchema />
