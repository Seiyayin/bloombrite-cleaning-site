      ...
      <main>
        ...
        <section className="relative bg-primary text-white -mt-16 pt-24 pb-20">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <h1 className="text-4xl font-bold mb-4">House Cleaning Services in {location.name}</h1>
            <p className="text-xl max-w-3xl mx-auto">
              At Bloombrite Cleaning, we proudly provide top-rated cleaning services to homeowners in {location.name}. With over 97 five-star reviews, our team is trusted by families and busy professionals who want a spotless home — without the stress.
            </p>
            <div className="mt-8">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="lg:w-2/3">
                <h2 className="text-2xl font-bold mb-6">Professional House Cleaning in {location.name}</h2>
