  ...
  return (
    <>
      <SeoHead 
        ...
        description="Professional house & office cleaning in Metro Detroit. Deep cleaning, move-in/out, recurring service. Licensed & insured. Serving Wixom, Novi, Livonia & more."
