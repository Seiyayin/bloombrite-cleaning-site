...
- October 5, 2025: Critical SEO fixes from Ahrefs audit (Part 2) - shortened all meta descriptions site-wide to 150-160 characters for optimal search display, added structured data JSON-LD support to SeoHead component, added comprehensive internal linking strategy with "Related Services" sections on all service pages (Window Cleaning, Power Washing, Carpet Cleaning), added "Related Articles" sections to location pages linking to city-specific blogs, enhanced service pages with cross-service links to reduce orphan pages and improve site structure
- October 5, 2025: Comprehensive SEO optimization based on Ahrefs audit - added canonical URLs to all pages (static and dynamic) using www.bloombritecleaning.com, shortened meta descriptions to under 160 characters for optimal search display, updated sitemap generation to use www subdomain for consistency, fixed robots.txt to point to production sitemap URL, verified all pages have H1 tags and internal links
